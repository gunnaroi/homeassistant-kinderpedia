...
def _make_calendar(hass: HomeAssistant, coordinator) -> KinderpediaCalendar:
...
async def test_calendar_builds_timed_school_events(hass: HomeAssistant):
    ...
    cal = _make_calendar(hass, coordinator)
...
async def test_calendar_event_property_none_outside_school_days(
    ...
    assert _make_calendar(hass, coordinator).event is None
...
async def test_calendar_extra_state_attributes_skips_empty_days(
    ...
    assert _make_calendar(hass, coordinator).extra_state_attributes == {}
